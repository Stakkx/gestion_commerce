...
if (isset($_GET['suppr'])){
    $req = $pdo->exec("DELETE FROM categorie WHERE id =".$_GET['suppr']);
    header('gestion_categories.php');
    $deleted = true;
}
                ...
                <div class="col-12">
                    <div class="card-box">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap">
                            ...
                            <tr>
                                <td> <?= $cat['titre'] ?> </td>
                                <td> <a href="modifier_categorie.php?id=<?= $cat['id'] ?>"><i class="fas fa-edit"></i> </a> </td>
                                <td> <a onclick="return confirmation();" href="gestion_categories.php?suppr=<?= $cat['id'] ?>"> <i class="fas fa-trash-alt"></i> </a> </td>
                            </tr>                         
                            <?php endforeach; ?>
                        </tbody>
                        </table>
