...
if (isset($_POST['titre'])){
    ...
    if ($stmt->fetchColumn() != 0) {
        ...
        $quantite_minimal = $_POST['quantite_minimal'];
        $poids = $_POST['poids'];
        ...
        $req->execute(array($titre, $id_categorie, $id_fournisseur, $prix_achat, $prix_vente, $quantite, $quantite_minimal, $poids, $code_barre, $image ));
        $added = true;
